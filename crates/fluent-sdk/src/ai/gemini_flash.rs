...
impl From<FluentGeminiFlashRequest> for FluentRequest {
    fn from(request: FluentGeminiFlashRequest) -> Self {
...
#[derive(Debug, Deserialize, Serialize, Clone)]
pub struct FluentGeminiFlashRequestBuilder {
    request: FluentGeminiFlashRequest,
}
impl Default for FluentGeminiFlashRequestBuilder {
    fn default() -> Self {
        Self {
            request: FluentGeminiFlashRequest {
                prompt: String::new(),
...
impl FluentGeminiFlashRequestBuilder {
    ...
    pub fn build(self) -> anyhow::Result<FluentGeminiFlashRequest> {
