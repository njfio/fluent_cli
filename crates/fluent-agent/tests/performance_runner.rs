use anyhow::Result;
use fluent_agent::performance::utils::{MemoryTracker, PerformanceCounter};
...
pub mod utils {
    ...
    pub async fn run_simple_test(name: &str, num_operations: usize) -> Result<PerformanceReport> {
